 ...
 *
 * GET    /api/super-admin/models/[id] - Get a single model by UUID
 * PATCH  /api/super-admin/models/[id] - Update a model (e.g., deprecation, pricing)
 * DELETE /api/super-admin/models/[id] - Delete a model (fails if referenced by roles)
 *
...
/**
 * PATCH /api/super-admin/models/[id]
...
/**
 * DELETE /api/super-admin/models/[id]
