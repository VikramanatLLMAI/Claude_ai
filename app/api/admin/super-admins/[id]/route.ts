 ...
 *
 * GET    /api/admin/super-admins/[id] - Get a Super Admin by ID
 * PATCH  /api/admin/super-admins/[id] - Update a Super Admin
 * DELETE /api/admin/super-admins/[id] - Delete a Super Admin
 *
...
/**
 * PATCH /api/admin/super-admins/[id]
